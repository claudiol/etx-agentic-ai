...
def run_agent(pod_name, namespace):
    ...
    #     '{"owner":"claudiol","repo":"etx-agentic-ai",'
    ...
    try:
        ...
        fallback_prompt = (
            ...
            "Then create a Github issue with owner 'claudiol', repo 'etx-agentic-ai', "
